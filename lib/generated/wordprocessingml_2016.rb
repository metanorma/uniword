...
module Uniword
  module Generated
    module Wordprocessingml2016
      ...
      autoload :PersistentDocumentId, File.expand_path('wordprocessingml_2016/persistent_document_id', __dir__)
      autoload :RowRsid, File.expand_path('wordprocessingml_2016/row_rsid', __dir__)
      autoload :SdtAppearance2016, File.expand_path('wordprocessingml_2016/sdt_appearance2016', __dir__)
      autoload :SeparatorExtension, File.expand_path('wordprocessingml_2016/separator_extension', __dir__)
      autoload :TableRsid, File.expand_path('wordprocessingml_2016/table_rsid', __dir__)
      autoload :WebVideoProperty, File.expand_path('wordprocessingml_2016/web_video_property', __dir__)
    end
  end
end