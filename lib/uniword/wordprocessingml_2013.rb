...
module Uniword
  module Wordprocessingml2013
    ...
    autoload :ChartTrackingRefBased, File.expand_path('wordprocessingml_2013/chart_tracking_ref_based', __dir__)
    ...
    autoload :RepeatingSectionItem, File.expand_path('wordprocessingml_2013/repeating_section_item', __dir__)
    ...
    autoload :WebExtensionLinked, File.expand_path('wordprocessingml_2013/web_extension_linked', __dir__)
