...
module Uniword
  module Drawingml
      ...
      class EffectStyle < Lutaml::Model::Serializable
        attribute :effect_lst, EffectList
        attribute :scene3d, Scene3D
      ...
      class FillStyleList < Lutaml::Model::Serializable
        attribute :solid_fills, SolidFill, collection: true
        attribute :gradient_fills, GradientFill, collection: true
