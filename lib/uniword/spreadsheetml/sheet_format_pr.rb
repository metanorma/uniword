  ...
  module Spreadsheetml
    ...
    class SheetFormatPr < Lutaml::Model::Serializable
      ...
      xml do
        ...
        map_attribute "defaultRowHeight", to: :default_row_height,
                                          render_nil: false
        map_attribute "dyDesiner", to: :dy_designer, render_nil: false
        map_attribute "outLineLevelRow", to: :out_line_level_row,
                                         render_nil: false
        map_attribute "outLineLevelCol", to: :out_line_level_col,
                                         render_nil: false
