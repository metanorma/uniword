...
module Uniword
  module WpDrawing
    ...
    autoload :DocProperties, File.expand_path('wp_drawing/doc_properties', __dir__)
    ...
    autoload :NonVisualDrawingProps, File.expand_path('wp_drawing/non_visual_drawing_props', __dir__)
