...
RSpec.describe Uniword::CommentsPart do
  ...
  describe 'XML serialization' do
    it 'serializes to XML with correct structure' do
      pending 'Full OOXML serialization support will be implemented with OoxmlSerializer integration'
      ...
      xml = comments_part.to_xml
      expect(xml).to include('w:comments')
      expect(xml).to include('w:comment')
      expect(xml).to include('author="John"')
      expect(xml).to include('author="Jane"')
    end
  end
end
