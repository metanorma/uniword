...
# Check if plurimath is available before requiring the adapter
begin
  require "plurimath"
...
require "uniword/math/plurimath_adapter" if PLURIMATH_AVAILABLE
require "uniword/math_equation"

# Only run these tests if plurimath is available
