...
RSpec.describe 'docx-js compatibility: Paragraph' do
  ...
  describe 'heading styles' do
    ...
    it 'creates heading 5' do
      para = Uniword::Paragraph.new
      para.properties.style = 'Heading5'
    ...
    it 'creates heading 6' do
      para = Uniword::Paragraph.new
      para.properties.style = 'Heading6'
  ...
  describe 'alignment' do
    ...
    it 'sets left alignment' do
      para = Uniword::Paragraph.new
      para.properties.alignment = 'left'
    ...
    it 'sets right alignment' do
      para = Uniword::Paragraph.new
      para.properties.alignment = 'right'
    ...
    it 'sets start alignment' do
      para = Uniword::Paragraph.new
      para.properties.alignment = 'start'
    ...
    it 'sets distribute alignment' do
      para = Uniword::Paragraph.new
      para.properties.alignment = 'distribute'
    ...
    it 'sets justified alignment' do
      para = Uniword::Paragraph.new
      para.properties.alignment = 'both'
  ...
  describe 'page breaks' do
    it 'adds page break as run element' do
      ...
      expect(para.runs.first.page_break).to be true
    end
  ...
  describe 'bullet lists' do
    it 'creates bullet paragraph with default level 0' do
      ...
      para = Uniword::Paragraph.new
      para.properties.style = 'ListParagraph'
      para.properties.numbering_level = 0
      para.properties.numbering_id = 1

      expect(para.properties.style).to eq('ListParagraph')
      expect(para.properties.numbering_level).to eq(0)
    end

    it 'creates bullet paragraph with level 1' do
      para = Uniword::Paragraph.new
      para.properties.style = 'ListParagraph'
      para.properties.numbering_level = 1
      para.properties.numbering_id = 1

      expect(para.properties.numbering_level).to eq(1)
    end
  end
  ...
  describe 'numbered lists' do
    it 'creates numbered paragraph with ListParagraph style' do
      ...
      para.properties.style = 'ListParagraph'
      para.properties.numbering_level = 0
      para.properties.numbering_id = 'test id'
    ...
    it 'allows custom style with numbering' do
      para = Uniword::Paragraph.new
      para.properties.style = 'myFancyStyle'
      para.properties.numbering_level = 0
      para.properties.numbering_id = 'test id'
    ...
    it 'supports numbering with instance' do
      ...
      para.properties.style = 'ListParagraph'
      para.properties.numbering_level = 0
      para.properties.numbering_id = '{test id-4}'

      expect(para.properties.numbering_id).to eq('{test id-4}')
    end
  end
  ...
  describe 'indentation' do
    it 'sets paragraph indent' do
      ...
      para = Uniword::Paragraph.new
      para.properties.indent_left = 720
  ...
  describe 'spacing' do
    it 'sets paragraph spacing' do
      ...
      para = Uniword::Paragraph.new
      para.properties.spacing_before = 90
      para.properties.spacing_line = 50

      expect(para.properties.spacing_before).to eq(90)
      expect(para.properties.spacing_line).to eq(50)
    end
  end
  ...
  describe 'outline level' do
    it 'sets paragraph outline level' do
      ...
      para = Uniword::Paragraph.new
      para.properties.outline_level = 0
  ...
  describe 'shading' do
    it 'sets shading with type, color, and fill' do
      ...
      para = Uniword::Paragraph.new
      para.properties.shading_type = :reverse_diagonal_stripe
      para.properties.shading_color = '00FFFF'
      para.properties.shading_fill = 'FF0000'

      expect(para.properties.shading_type).to eq(:reverse_diagonal_stripe)
