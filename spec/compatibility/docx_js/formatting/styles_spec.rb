  ...
  describe "Styles" do
    describe "createParagraphStyle" do
      ...
      it "should create paragraph style with id" do
        ...
        added_style = doc.styles_configuration.paragraph_styles.find { |s| s.style_id == "pStyleId" }
    ...
    describe "createCharacterStyle" do
      it "should create a new character style" do
        ...
        added_style = doc.styles_configuration.character_styles.find { |s| s.style_id == "cStyleId" }
        expect(added_style).not_to be_nil
    ...
    describe "style inheritance" do
      it "should support based-on style" do
        ...
        added_style = doc.styles_configuration.paragraph_styles.find { |s| s.style_id == "DerivedStyle" }
        expect(added_style).not_to be_nil
      ...
      it "should support next style" do
        ...
        added_style = doc.styles_configuration.paragraph_styles.find { |s| s.style_id == "Heading1" }
        expect(added_style).not_to be_nil
    ...
    describe "style properties" do
      it "should set paragraph style with formatting" do
        ...
        added_style = doc.styles_configuration.paragraph_styles.find { |s| s.style_id == "CustomPara" }
        expect(added_style).not_to be_nil
      ...
      it "should set paragraph style with paragraph formatting" do
        ...
        added_style = doc.styles_configuration.paragraph_styles.find { |s| s.style_id == "IndentedPara" }
        expect(added_style).not_to be_nil
      ...
      it "should set character style with formatting" do
        ...
        added_style = doc.styles_configuration.character_styles.find { |s| s.style_id == "CustomChar" }
        expect(added_style).not_to be_nil
