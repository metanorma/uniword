...
# Simple test script for enhanced ParagraphProperties
# This test avoids the circular dependency issue by testing properties directly
...
require_relative 'lib/uniword/properties/tab_stop'
require_relative 'lib/uniword/properties/numbering_properties'
require_relative 'lib/uniword/properties/frame_properties'

# Test basic paragraph properties
puts 'Testing Enhanced ParagraphProperties (Simple Test)...'

# Create paragraph properties with basic features
...
begin
  ...
  props.shading_color = Uniword::Properties::ParagraphShading.solid('FF0000')
