...
| Document structure
| Runs model-level validation rules via `Validation::Engine`: body presence, bookmark pairing and uniqueness, required table elements (`tblGrid`, `tblPr`), empty paragraphs
